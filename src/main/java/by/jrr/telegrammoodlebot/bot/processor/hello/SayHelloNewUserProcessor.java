package by.jrr.telegrammoodlebot.bot.processor.hello;//package by.jrr.telegram.bot.processor.hello;
//
...
//import org.telegram.telegrambots.meta.api.objects.ServiceMessage;
...
//            ServiceMessage message = update.getMessage();
...
//    }
//
//    private void findLatestTelegramChatActionAndBindProfile(ServiceMessage message) { // TODO: 29/07/20 consider to publish this as a broadcasting event
...
//    }
//
//    private Optional<TgUser> getTgUserFromMessageFromNewChatMember(ServiceMessage message) {
...
//    }
//
//    private void sendIntroductionMessage(ServiceMessage message, TgUser tgUser) {
//        new Thread(() -> {
//            try {
...
//    }
//
//    private String getNotificationMessageForAdmin(TgUser tgUser, ServiceMessage message) {
